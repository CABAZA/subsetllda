...
import gr.auth.csd.mlkd.evaluation.EvaluateFastXML;
...
public class FastXMLWrapper {
    ...
    public static void main(String args[]) throws InterruptedException, IOException {
        ...
        process = new ProcessBuilder("./eval.sh", "bibtex", "predictions").redirectError(new File("err.txt")).redirectOutput(new File("out.txt")).start();
        process.waitFor();
    }
