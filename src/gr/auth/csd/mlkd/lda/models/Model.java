...
public class Model {
    ...
    public Model(DatasetTfIdf data, double a, boolean inf, double b, boolean perp,
...
//        System.out.println("V " + V);
    ...
    protected double[][] computePhi() {
        ...
        for (int k = 0; k < K; k++) {
            ...
            System.arraycopy(tempPhi, 0, phi[k], 0, V);
        }
        return phi;
    }
    ...
    protected double[][] computeTheta(boolean finalSample) {
        ...
        for (int d = 0; d < M; d++) {
            ...
            System.arraycopy(tempTheta, 0, theta[d], 0, K);
        }
        return theta;

    }

    public double logLikelihood(DatasetTfIdf data, double phi[][], double[][] theta) {
        double ll = 0;
