package gr.auth.csd.mlkd.atypon.lda.models;


import gr.auth.csd.mlkd.atypon.lda.CallableInferencer;
import gr.auth.csd.mlkd.atypon.lda.Evaluate;
...
public class Model {
    ...
    public Model(DatasetBoW data, double a, boolean inf, double b, boolean perp,
...
//        System.out.println("V " + V);
    ...
    public double logLikelihood(DatasetBoW data, double phi[][], double[][] theta) {
        double ll = 0;
    ...
    public double[][] inference() {
        ...
        for (int i = 1; i <= niters; i++) {
            if(i%50==0) System.out.println(new Date()+" "+i);
            exec();
