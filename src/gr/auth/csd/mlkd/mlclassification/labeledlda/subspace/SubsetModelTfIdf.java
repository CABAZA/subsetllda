...
import static gr.auth.csd.mlkd.atypon.mlclassification.labeledlda.models.Model.readPhi;
...
public class SubsetModelTfIdf extends OnlyCGS_pPriorModelTfIdf implements Serializable {

    static final long serialVersionUID = -7219137807901737L;
    private final double[][] alphaPrior;
    private final int[][] possibleLabels;

    public SubsetModelTfIdf(Dataset data, String trainedModelName, int threads, int iters, int burnin, String ls) {
        super();
