 ...
 */
public class MostRelevantJaccard extends MostRelevantTfIdf {

    public MostRelevantJaccard(int n, CmdOption option) {
        super(n, option);
    }

    public MostRelevantJaccard(int n, String testFile, String trainFile) {
