...
public class Timer {
    ...
    public String durationSeconds() {
        ...
        public String durationMiliSeconds() {
        StringBuilder sb = new StringBuilder();
        sb.append(String.format("Wall time (miliseconds): "+ (System.currentTimeMillis() - wall)));
        sb.append(String.format("\nUser time (miliseconds): %.2f\n", (getUserTime() - user) / (1000.0 * 1000)));
        sb.append(String.format("System time (miliseconds): %.2f\n", (getSystemTime() - system) / (1000.0 * 1000)));
        sb.append(String.format("CPU time (miliseconds): %.2f\n", (getCPUTime() - cpu) / (1000.0 * 1000)));
        return sb.toString();
    }
