...
public class StopWords { 
    ...
    public StopWords(int n) { 
        m_Words = new HashSet();
        if(n==1) addFromFile(10000, "../../atypon/stopwords/aggressive_stoplist.txt");
        else if(n==2) addFromFile(10000, "../../atypon/stopwords/medicalconservative.txt");
        else if (n==3) addFromFile(10000, "../../atypon-dl/atypon/src/stopwords/stoplist.txt");
        else if (n==4) addFromFile(10000, "../../atypon-dl/atypon/src/stopwords/stopconservative.txt");
